/*
 * File Name: Shortest Path using BFS
 *
 * Credit : Course     : Graph Search, Shortest Paths, and Data Structures, Stanford University on Coursera.
 *          Instructor : Tim Roughgarden, Professor
            Website    : https://www.freecodecamp.org/news/exploring-the-applications-and-limits-of-breadth-first-search-to-the-shortest-paths-in-a-weighted-1e7b28b3307/
 *
 * Author: Mrunal Nirajkumar Shah
 * Date: 18th Of FEBURARY, 2023
 *
 * Description:  We find Shortest path using BFS
 */
