 ...
 *
 * Description: Implementation of Kosaraju's Algorithm to find; Strongly Connected Components for 2 SAT problem
 * Dependencies: This Code require files named "2sat1.txt"..."2sat6.txt" and compile one at a time.
 */
