 ...
 *
 * Description:  code up and run the randomized contraction algorithm for the min cut problem and use it on the above graph to compute the min cut.
 *
 * Dependencies: This Code requires a txt file named "02.kargerMinCut.txt". (you can change the numbers too)
 */
...
int main() {
  ...
  ifstream file("02.kargerMinCut.txt");
  string str;
  int val;
  int E = 0;
  ...
  ifstream file2("02.kargerMinCut.txt");
  string str2;
  int val2;
  int edgeCount = 0;
