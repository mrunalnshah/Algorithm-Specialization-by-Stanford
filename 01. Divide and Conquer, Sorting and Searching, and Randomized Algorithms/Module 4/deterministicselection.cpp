/*
 * File Name: deterministic selection
 *
 ...
 *
 * Description:  A deterministic algorithm is an algorithm that is purely determined by its inputs, where no randomness is involved in the model.
 */
